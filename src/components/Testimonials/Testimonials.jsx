        ...
        <div className="carousel-inner">
          ...
          <div className="carousel-item active">
            ...
            <div className="testimonials__picture">
              <img src={require("../../assets/images/testimonials/client-1.jpg").default} alt="client-1 picture" className="rounded-circle img-fluid" />
            </div>
          ...
          <div className="carousel-item">
            ...
            <div className="testimonials__picture">
              <img src={require("../../assets/images/testimonials/client-2.jpg").default} alt="client-2 picture" className="rounded-circle img-fluid" />
            </div>
          ...
          <div className="carousel-item">
            ...
            <div className="testimonials__picture">
              <img src={require("../../assets/images/testimonials/client-3.jpg").default} alt="client-3 picture" className="rounded-circle img-fluid" />
            </div>
          ...
          <div className="carousel-item">
            ...
            <div className="testimonials__picture">
              <img src={require("../../assets/images/testimonials/client-4.jpg").default} alt="client-4 picture" className="rounded-circle img-fluid" />
            </div>
